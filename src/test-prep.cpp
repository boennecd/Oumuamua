...
context("Testing 'XY_dat'") {
  test_that("Constructor of 'XY_dat' yields correct result") {
    /* R code
     ...
     dput_2_cpp(scale(y, scale = FALSE))
    ...
    { -0.753333333333333, 0.766666666666667, -0.0833333333333333, 0.366666666666667, -1.41333333333333, 1.11666666666667 };
    ...
    expect_true(is_all_aprx_equal(XY.c_y, ey));
